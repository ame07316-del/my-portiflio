...
export const dict = {
  en: {
    ...
    tour: {
      ...
      hint: "section by section",
      exit: "esc or skip to explore yourself",
      skip: "Skip",
      replay: "Replay the guided tour",
      day: "Daylight",
      night: "Nightfall",
    },
    globe: {
  ...
  ar: {
    ...
    tour: {
      button: "إعادة الجولة",
      hint: "قسم قسم بالراحة",
      exit: "اضغط esc أو تخطي عشان تتصفح بنفسك",
      skip: "تخطي",
      replay: "إعادة الجولة الإرشادية",
      day: "شروق",
      night: "غروب",
    },
    globe: {
